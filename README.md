...
> The tables below were generated by actually running the schema and queries against a test database, so the numbers reflect the sample data included in the script.
